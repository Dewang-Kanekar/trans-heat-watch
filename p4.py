...
class GUI:
    def __init__(self, master):
        ...
        self.hot_image_label = self.create_image_label(self.image_frame, "Hot Image", "C:\\Users\\dkkan\\Downloads\\project1\\project1\\transform_images\\validation\\hot_thermal images\\bosonpluscapture2.jpeg")
        self.cool_image_label = self.create_image_label(self.image_frame, "Cool Image", "C:\\Users\\dkkan\\Downloads\\project1\\project1\\transform_images\\validation\\cool_thermal_images\\The-thermogram-shows-the-wiring-connections-in-three-current-transformers-Un-110-kV_Q320.jpg")
        self.short_circuit_label = self.create_image_label(self.image_frame, "Short Circuit", "C:\\Users\\dkkan\\Downloads\\project1\\project1\\transform_images\\validation\\short_ciruit_img\\hqdefault.jpg")
        self.fire_label = self.create_image_label(self.image_frame, "Fire", "C:\\Users\\dkkan\\Downloads\\project1\\project1\\transform_images\\validation\\fire_img\\main-qimg-b5d84b81e2d2a474ade26902b40214d6-pjlq.jpg")
    ...
    def create_image_label(self, parent, text, image_path):
